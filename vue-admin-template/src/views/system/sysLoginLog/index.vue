<template>
  <div class="container">
    ...
    <el-table
      ...
      <el-table-column prop="ipaddr" label="登录IP地址" width="200"/>
...
import api from '@/api/log/loginlogs.js'
      ...
      console.log(this.searchObj)
        ...
        api.getPageList(this.page,this.limit,this.searchObj).then(
          response => {
            ...
            this.allLoginLogs = response.data.records
